...
public class MainController {
    ...
    public String changeCashOnAccount(@PathVariable(name = "login") String login,
                                      ...
                                      @ModelAttribute(name = "cashCurrency") @RequestParam(value = "cashCurrency", defaultValue = "RUB") String cashCurrency,
                                      BindingResult bindingResult,
                                      Model model) {
    ...
    public String transferMoney(@PathVariable(name = "login") String login,
                                @ModelAttribute(name = "from_currency")  @RequestParam(value = "from_currency", defaultValue = "RUB") String fromCurrency,
                                @ModelAttribute(name = "to_currency") @RequestParam(value = "to_currency", defaultValue = "RUB") String toCurrency,
    ...
    public void prepareMainModel(Authentication authentication,
        ...
        model.addAttribute("sum", accountsInfo.stream().map(AccountInfoDto::getValue).reduce(BigDecimal.ZERO, BigDecimal::add));
